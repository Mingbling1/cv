...
import { RESUME_DATA } from "@/app/(main)/_data/resume-data";
        ...
        <main className="container relative mx-auto scroll-my-12 overflow-auto p-4 print:p-12 md:p-16">
            ...
            <section className="mx-auto w-full max-w-2xl space-y-8 print:space-y-4">
                    ...
                    {RESUME_DATA.work.map((work) => {
                        return (
                            <Card key={work.company}>
                                ...
                                <CardContent className="mt-2 text-xs print:text-[10px] text-muted-foreground">
                                    {work.description}
                                </CardContent>
                            </Card>
                        );
                ...
                <Section className="print-force-new-page scroll-mb-16">
                    ...
                    <div
                        className={cn(
                            "-mx-3 grid grid-cols-1 gap-3 print:grid-cols-3 print:gap-2 md:grid-cols-2",
